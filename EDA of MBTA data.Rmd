...
## Data Cleaning
Select one week from each month
```{r echo = FALSE, warning = FALSE, message = FALSE}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.dim='Figure 1: Travel time between two stops of LR routes in seconds',fig.align='center'}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.dim='Figure 2: Travel time between two stops of HR routes in seconds',fig.align='center'}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.dim='Figure 3: Amount of different routes ranked',fig.align='center'}
...
Different train to the stop 70107
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.dim='Figure 4: Average spending time from different stations to 70107',fig.align='center'}
...
Route date and time spent between stop 70117 and 70107
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.dim='Figure 5: Average spending time between stop 70117 and 70107 on different date',fig.align='center'}
...
Delay of Route 57 at different date
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.height=10, fig.dim='Figure 6: Average delay time between different stops of route 57 at different date',fig.align='center'}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.dim='Figure 7: Start time, time enter the midpoint stop, and end time of route 57',fig.align='center'}
